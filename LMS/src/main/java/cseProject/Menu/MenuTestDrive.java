...
//        MenuComponent generalMenu = new Menu("이용자 메뉴");
//        MenuComponent bookManage = new Menu("도서 관리 메뉴");
        //메뉴 객체들 생성
//
...
//        // 전체 메뉴에 각 메뉴 추가
//
//        managerMenu.add(new MenuItem("도서 등록/삭제/수정"));
//        // 관리자 메뉴에 메뉴 추가
//        managerMenu.add(bookManage);
//        // 관리자 메뉴 속 메뉴 추가
//
//        bookManage.add(new MenuItem("도서 등록"));
//        bookManage.add(new MenuItem("도서 삭제"));
//        //메뉴 속 메뉴에 메뉴 항목 생성
